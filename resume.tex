...
\newcommand{\cvItemGithubLink}[1]{\cvItemT{\small\githubIcon\href{https://github.com/#1}{#1}}}
...
\def \nameSuffix{}
\def \subtitleText{Python/Rust разработчик, SRE}
% 
...
\begin{document}
	...
	\cvEntryPersonalND{Homelab}{
		...
		\cvItemT{
			Набор сервисов, развёрнутых на моём домашнем сервере, для которых я потихоньку делаю автоматизацию и мониторинг.
		}
		\cvItemSkillset{
			\item Linux
			\item Nginx
