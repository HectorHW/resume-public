...
\begin{document}
	...
	\cvEntryNTPD{Тинькофф}{сентябрь 2023 -- present}{Младший разработчик}{
		\cvItemText{
			Занимаюсь разработкой и развёртыванием системы сбора и обогащения логов, упрощающей жизнь сотрудников ИБ и поддержки. Налаживаю Continuous Delivery и развиваю чат-бота, которым пользуется весь инфраструктурный отдел.
		}
		\cvItemSkillset{
			\item Ansible
			\item Docker
